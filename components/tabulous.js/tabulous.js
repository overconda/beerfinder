        ...
        init: function() {
            ...
            links.bind('click', {myOptions: this.options}, function(e) {
                ...
                if (effect == 'scale') {
                    ...
                    alldivs.removeClass('showcustom').addClass('make_transist').addClass('hidecustom');
                    thisform.find('.route-info-wrapper'+'#'+thislink).addClass('make_transist').addClass('showcustom');
                }
